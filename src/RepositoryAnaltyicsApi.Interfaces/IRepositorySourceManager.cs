...
namespace RepositoryAnaltyicsApi.Interfaces
{
    public interface IRepositorySourceManager
    {
        ...
        Task<RepositorySummary> ReadRepositorySummaryAsync(string owner, string name);
        Task<CursorPagedResults<RepositorySummary>> ReadRepositorySummariesAsync(string owner, int take, string endCursor);
